# Task AGENTS.md — analyst run (Cursor agent)
...
Configured inline by the orchestrator from `{TASK_ROOT_ABS}/.mcp.json`.
Discover tool names via the server's `tools/list` on first contact — do NOT
name tools from memory.
